<%-- 
    Document   : Sucess
    Created on : 27 Feb, 2022, 3:27:57 PM
    Author     : Anisha
--%>
  ...
  <div class="container-fluid">
    <div class="navbar-header">
      ...
      <ul class="nav navbar-nav navbar-right" >
        ...
        <span class="glyphicon glyphicon-user"></span> Student</a>
        </li>
      </ul>
    </div>
...
<div class="container-fluid text-center">
  ...
  <div class="row">
    ...
    <div class="col-sm-4">
        <a href="StudentAssignenment.jsp" target="_self">
        <button type="button" class="btn btn-link"> 
