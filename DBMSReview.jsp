<%-- 
    Document   : DBMSReview
    Created on : 27 Apr, 2022, 11:54:39 PM
    Author     : Anisha
--%>
...
<!DOCTYPE html>
<%
    ResultBean DBMS = (ResultBean)request.getAttribute("RB");
    int[] ans = DBMS.getDBMSResult();
    boolean[] verd = DBMS.getDBMSAnswers();
 %>
...
<html>
    ...
    <body>
        ...
        <h2 class = "result-board" >Score   | <%=DBMS.getDBMSScores() %> / 20 </h2><br>
        <h2 class = "result-board">Verdict <br><%=DBMS.getDBMSVerdict() %> </h2>
